        ...
        <form class="form-horizontal" method="post" id="member_update_form">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="member_number" name="number" placeholder="请输入工号" required>
              </div>
            </div>
            <div class="form-group">
              <label for="member_name" class="col-sm-2 control-label">姓名</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="member_name" name="name" maxlength="10" placeholder="请输入姓名" required>
              </div>
            </div>
            <div class="form-group">
              <label for="member_mobile" class="col-sm-2 control-label">手机</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="member_mobile" name="mobile" maxlength="11" placeholder="请输入手机" required>
              </div>
            </div>
            <div class="form-group">
              <label for="member_email" class="col-sm-2 control-label">Email</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="member_email" name="email" placeholder="请输入Email，选填">
              </div>
            </div>
            <div class="form-group">
              <label for="member_extra" class="col-sm-2 control-label">备注</label>
              <div class="col-sm-10">
                <textarea class="form-control" rows="3" id="member_extra" name="extra" placeholder="请输入备注，100字以内，选填"></textarea>
              </div>
            </div>
          </div>
          <!-- /.box-body -->
            ...
            if (confirm("确认要删除吗？")) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            //菜单栏当前选中
                            window.location.href ="/Xungeng/member/showList";
