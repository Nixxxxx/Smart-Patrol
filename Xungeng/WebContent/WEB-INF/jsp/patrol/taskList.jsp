						...
						<c:if test="${taskList != null }">
							<c:forEach var="task" items="${taskList }" varStatus="status">
								<tr>
									...
									<td><a data-record-id="${task.recordId }"
										class="show_detail" href="javascript:void(0)">查看详情</a></td>
									<td><a data-id="${task.id }" class="del"
            ...
            if (confirm("确认要删除吗？")) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            //菜单栏当前选中
                            window.location.href="patrol/showTaskList";
