        ...
        <form class="form-horizontal" method="post" id="patrol_add_form">
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select class="form-control select2" name="member" id="patrol_member" style="width: 100%">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select class="form-control select2" name="device" id="patrol_device" style="width: 100%">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control pull-right" name="date" id="patrol_date">
              </div>
            </div>
            <div class="form-group">
              <label for="device_extra" class="col-sm-2 control-label">备注</label>
              <div class="col-sm-10">
                <textarea class="form-control" rows="3" id="device_extra" name="extra" placeholder="请输入备注，100字以内，选填"></textarea>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-9">
                ...
                <div class="row" id="location_time_content" style="cursor: pointer" data-toggle="modal" data-target="#patrol_location_time_modal" data-backdrop="static">
                  <div class="col-sm-12"><p class="form-control-static">点击选择地点与时段</p></div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="box-footer">
            ...
            <button type="submit" class="btn btn-info pull-right" id="patrol_add_button" data-loading-text="添加中...">添加</button>
          </div>
          <!-- /.box-footer -->
        </form>
      </div>
...
<!-- Modal -->
<div class="modal fade" id="patrol_location_time_modal" tabindex="-1" role="dialog" aria-labelledby="patrol_location_time_label">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-6 col-sm-4">
                    <label class="radio-inline">
                      <input type="radio" name="location" value="${location.id }|${location.number }-${location.name }">
