...
<body>
						...
						<c:if test="${locationList!=null }">
							<c:forEach var="location" items="${locationList }"
								...
								<tr>
									...
									<td><fmt:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${location.addTime }"/></td>
									<td><a data-id="${location.id }" class="update"
										href="javascript:void(0)" data-toggle="modal"
										data-remote="false" data-target="#location_update_modal"
										data-backdrop="static"> <i class="fa fa-edit"></i>编辑
									</a> | <a data-id="${location.id }" class="del"
	...
	<!-- Modal -->
	<div class="modal fade" id="location_update_modal" tabindex="-1"
		role="dialog" aria-labelledby="location_update_label">
			...
			<div class="modal-content">
				...
				<div class="box box-info">
					...
					<form class="form-horizontal" method="post"
						id="location_update_form">
						<div class="box-body">
							<input type="hidden" id="location_id" name="id">
							<div class="form-group">
								<label for="location_number" class="col-sm-2 control-label">编号</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" id="location_number"
										name="number" placeholder="请输入地点编号" required>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="location_name"
										name="name" maxlength="10" placeholder="请输入地点名" required>
								</div>
							</div>
							<div class="form-group">
								<label for="location_extra" class="col-sm-2 control-label">备注</label>
								<div class="col-sm-10">
									<textarea class="form-control" rows="3" id="location_extra"
						...
						<div class="box-footer">
							...
							<button type="submit" class="btn btn-info pull-right"
								id="location_update_button" data-loading-text="更新中...">更新</button>
						</div>
						<!-- /.box-footer -->
					</form>
				</div>
            ...
            if (confirm("确认要删除吗？")) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            //菜单栏当前选中
                            window.location.href="location/showList";
