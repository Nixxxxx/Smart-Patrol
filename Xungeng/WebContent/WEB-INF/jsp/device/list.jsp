        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover table-bordered text-center">
            ...
            <tr>
              ...
              <td>
                <a data-id="${device.id }" class="update" href="javascript:void(0)" data-toggle="modal" data-remote="false" data-target="#device_update_modal" data-backdrop="static">
                  <i class="fa fa-edit"></i>编辑</a> |
                <a data-id="${device.id }" class="del" href="javascript:void(0)">
...
<!-- Modal -->
<div class="modal fade" id="device_update_modal" aria-labelledby="device_update_label">
        ...
        <form class="form-horizontal" method="post" id="device_update_form">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="device_number" name="number" placeholder="请输入设备编号" required>
              </div>
            </div>
            <div class="form-group">
              <label for="device_name" class="col-sm-2 control-label">设备名</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="device_name" name="name" maxlength="10" placeholder="请输入设备名" required>
              </div>
            </div>
            <div class="form-group">
          ...
          <div class="box-footer">
            ...
            <button type="submit" class="btn btn-info pull-right" id="device_update_button" data-loading-text="更新中...">更新</button>
          </div>
          <!-- /.box-footer -->
        </form>
      </div>
            ...
            if (confirm("确认要删除吗？")) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            //菜单栏当前选中
                            window.location.href="/Xungeng/device/showList";
